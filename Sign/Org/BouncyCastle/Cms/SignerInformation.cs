...
using Sign.Org.BouncyCastle.Crypto.Signers;
...
namespace Sign.Org.BouncyCastle.Cms
{
    public class SignerInformation
    {
        ...
        private Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable signedAttributeTable;

        private Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable unsignedAttributeTable;
        ...
        public Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable SignedAttributes
        {
            get
            {
                if (signedAttributeSet != null && signedAttributeTable == null)
                {
                    signedAttributeTable = new Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable(signedAttributeSet);
                }
        ...
        public Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable UnsignedAttributes
        {
            get
            {
                if (unsignedAttributeSet != null && unsignedAttributeTable == null)
                {
                    unsignedAttributeTable = new Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable(unsignedAttributeSet);
                }
        ...
        internal SignerInformation(SignerInfo info, DerObjectIdentifier contentType, CmsProcessable content, IDigestCalculator digestCalculator)
        {
            ...
            try
            {
                ...
                {
                    IssuerAndSerialNumber instance2 = IssuerAndSerialNumber.GetInstance(signerID.ID);
        ...
        {
            Sign.Org.BouncyCastle.Asn1.Cms.AttributeTable unsignedAttributes = UnsignedAttributes;
            ...
            foreach (Attribute item in unsignedAttributes.GetAll(CmsAttributes.CounterSignature))
            {
                ...
                {
                    SignerInfo instance = SignerInfo.GetInstance(item2.ToAsn1Object());
        ...
        private Asn1Object GetSingleValuedSignedAttribute(DerObjectIdentifier attrOID, string printableName)
        {
            ...
            switch (all.Count)
            {
                ...
                case 1:
                    {
                        Asn1Set attrValues = ((Asn1.Cms.Attribute)all[0]).AttrValues;
        ...
        public static SignerInformation ReplaceUnsignedAttributes(SignerInformation signerInformation, AttributeTable unsignedAttributes)
        {
            ...
            return new SignerInformation(new SignerInfo(signerInfo.SignerID, signerInfo.DigestAlgorithm, signerInfo.AuthenticatedAttributes, signerInfo.DigestEncryptionAlgorithm, signerInfo.EncryptedDigest, unauthenticatedAttributes), signerInformation.contentType, signerInformation.content, null);
        }

        public static SignerInformation AddCounterSigners(SignerInformation signerInformation, SignerInformationStore counterSigners)
        {
            SignerInfo signerInfo = signerInformation.info;
            Asn1.Cms.AttributeTable unsignedAttributes = signerInformation.UnsignedAttributes;
            ...
            return new SignerInformation(new SignerInfo(signerInfo.SignerID, signerInfo.DigestAlgorithm, signerInfo.AuthenticatedAttributes, signerInfo.DigestEncryptionAlgorithm, signerInfo.EncryptedDigest, new DerSet(asn1EncodableVector)), signerInformation.contentType, signerInformation.content, null);
        }
    }
}
