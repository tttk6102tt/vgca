...
namespace Sign.Org.BouncyCastle.Security
{
    public sealed class DigestUtilities
    {
        ...
        static DigestUtilities()
        {
            ...
            ((DigestAlgorithm)(object)Sign.Org.BouncyCastle.Utilities.Enums.GetArbitraryValue(typeof(DigestAlgorithm))).ToString();
        ...
        public static IDigest GetDigest(string algorithm)
        {
            ...
            try
            {
                switch ((DigestAlgorithm)(object)Sign.Org.BouncyCastle.Utilities.Enums.GetEnumValue(typeof(DigestAlgorithm), text2))
                {
