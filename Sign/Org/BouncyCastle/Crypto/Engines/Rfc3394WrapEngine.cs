...
namespace Sign.Org.BouncyCastle.Crypto.Engines
{
    public class Rfc3394WrapEngine : IWrapper
    {
        ...
        public string AlgorithmName => engine.AlgorithmName;
        ...
        public byte[] Wrap(byte[] input, int inOff, int inLen)
        {
            ...
            Array.Copy(input, 0, array, iv.Length, inLen);
        ...
        public byte[] Unwrap(byte[] input, int inOff, int inLen)
        {
            ...
            Array.Copy(input, 0, array2, 0, iv.Length);
            Array.Copy(input, iv.Length, array, 0, inLen - iv.Length);
