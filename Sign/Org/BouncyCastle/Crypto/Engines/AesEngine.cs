...
namespace Sign.Org.BouncyCastle.Crypto.Engines
{
    public class AesEngine : IBlockCipher
    {
        ...
        {
            uint[][] workingKey = WorkingKey;
            int num = 0;
            uint[] array = workingKey[num];
            C0 ^= array[0];
            C1 ^= array[1];
            C2 ^= array[2];
            C3 ^= array[3];
            ...
            while (num < ROUNDS - 2)
            {
                array = workingKey[++num];
                num2 = T0[C0 & 0xFF] ^ Shift(T0[(C1 >> 8) & 0xFF], 24) ^ Shift(T0[(C2 >> 16) & 0xFF], 16) ^ Shift(T0[(C3 >> 24) & 0xFF], 8) ^ array[0];
                num3 = T0[C1 & 0xFF] ^ Shift(T0[(C2 >> 8) & 0xFF], 24) ^ Shift(T0[(C3 >> 16) & 0xFF], 16) ^ Shift(T0[(C0 >> 24) & 0xFF], 8) ^ array[1];
                num4 = T0[C2 & 0xFF] ^ Shift(T0[(C3 >> 8) & 0xFF], 24) ^ Shift(T0[(C0 >> 16) & 0xFF], 16) ^ Shift(T0[(C1 >> 24) & 0xFF], 8) ^ array[2];
                num5 = T0[C3 & 0xFF] ^ Shift(T0[(C0 >> 8) & 0xFF], 24) ^ Shift(T0[(C1 >> 16) & 0xFF], 16) ^ Shift(T0[(C2 >> 24) & 0xFF], 8) ^ array[3];
                array = workingKey[++num];
                C0 = T0[num2 & 0xFF] ^ Shift(T0[(num3 >> 8) & 0xFF], 24) ^ Shift(T0[(num4 >> 16) & 0xFF], 16) ^ Shift(T0[(num5 >> 24) & 0xFF], 8) ^ array[0];
                C1 = T0[num3 & 0xFF] ^ Shift(T0[(num4 >> 8) & 0xFF], 24) ^ Shift(T0[(num5 >> 16) & 0xFF], 16) ^ Shift(T0[(num2 >> 24) & 0xFF], 8) ^ array[1];
                C2 = T0[num4 & 0xFF] ^ Shift(T0[(num5 >> 8) & 0xFF], 24) ^ Shift(T0[(num2 >> 16) & 0xFF], 16) ^ Shift(T0[(num3 >> 24) & 0xFF], 8) ^ array[2];
                C3 = T0[num5 & 0xFF] ^ Shift(T0[(num2 >> 8) & 0xFF], 24) ^ Shift(T0[(num3 >> 16) & 0xFF], 16) ^ Shift(T0[(num4 >> 24) & 0xFF], 8) ^ array[3];
            }
            ...
            num5 = T0[C3 & 0xFF] ^ Shift(T0[(C0 >> 8) & 0xFF], 24) ^ Shift(T0[(C1 >> 16) & 0xFF], 16) ^ Shift(T0[(C2 >> 24) & 0xFF], 8) ^ array[3];
            array = workingKey[++num];
            C0 = (uint)(S[num2 & 0xFF] ^ (S[(num3 >> 8) & 0xFF] << 8) ^ (S[(num4 >> 16) & 0xFF] << 16) ^ (S[(num5 >> 24) & 0xFF] << 24)) ^ array[0];
            C1 = (uint)(S[num3 & 0xFF] ^ (S[(num4 >> 8) & 0xFF] << 8) ^ (S[(num5 >> 16) & 0xFF] << 16) ^ (S[(num2 >> 24) & 0xFF] << 24)) ^ array[1];
            C2 = (uint)(S[num4 & 0xFF] ^ (S[(num5 >> 8) & 0xFF] << 8) ^ (S[(num2 >> 16) & 0xFF] << 16) ^ (S[(num3 >> 24) & 0xFF] << 24)) ^ array[2];
            C3 = (uint)(S[num5 & 0xFF] ^ (S[(num2 >> 8) & 0xFF] << 8) ^ (S[(num3 >> 16) & 0xFF] << 16) ^ (S[(num4 >> 24) & 0xFF] << 24)) ^ array[3];
        }
        ...
        private void DecryptBlock()
        {
            ...
            {
                array = workingKey[--num];
                num2 = Tinv0[C0 & 0xFF] ^ Shift(Tinv0[(C3 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(C2 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(C1 >> 24) & 0xFF], 8) ^ array[0];
                num3 = Tinv0[C1 & 0xFF] ^ Shift(Tinv0[(C0 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(C3 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(C2 >> 24) & 0xFF], 8) ^ array[1];
                num4 = Tinv0[C2 & 0xFF] ^ Shift(Tinv0[(C1 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(C0 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(C3 >> 24) & 0xFF], 8) ^ array[2];
                num5 = Tinv0[C3 & 0xFF] ^ Shift(Tinv0[(C2 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(C1 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(C0 >> 24) & 0xFF], 8) ^ array[3];
                array = workingKey[--num];
                C0 = Tinv0[num2 & 0xFF] ^ Shift(Tinv0[(num5 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num4 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num3 >> 24) & 0xFF], 8) ^ array[0];
                C1 = Tinv0[num3 & 0xFF] ^ Shift(Tinv0[(num2 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num5 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num4 >> 24) & 0xFF], 8) ^ array[1];
                C2 = Tinv0[num4 & 0xFF] ^ Shift(Tinv0[(num3 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num2 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num5 >> 24) & 0xFF], 8) ^ array[2];
                C3 = Tinv0[num5 & 0xFF] ^ Shift(Tinv0[(num4 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num3 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num2 >> 24) & 0xFF], 8) ^ array[3];
            }
            ...
            num5 = Tinv0[C3 & 0xFF] ^ Shift(Tinv0[(C2 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(C1 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(C0 >> 24) & 0xFF], 8) ^ array[3];
            array = workingKey[--num];
            C0 = (uint)(Si[num2 & 0xFF] ^ (Si[(num5 >> 8) & 0xFF] << 8) ^ (Si[(num4 >> 16) & 0xFF] << 16) ^ (Si[(num3 >> 24) & 0xFF] << 24)) ^ array[0];
            C1 = (uint)(Si[num3 & 0xFF] ^ (Si[(num2 >> 8) & 0xFF] << 8) ^ (Si[(num5 >> 16) & 0xFF] << 16) ^ (Si[(num4 >> 24) & 0xFF] << 24)) ^ array[1];
            C2 = (uint)(Si[num4 & 0xFF] ^ (Si[(num3 >> 8) & 0xFF] << 8) ^ (Si[(num2 >> 16) & 0xFF] << 16) ^ (Si[(num5 >> 24) & 0xFF] << 24)) ^ array[2];
            C3 = (uint)(Si[num5 & 0xFF] ^ (Si[(num4 >> 8) & 0xFF] << 8) ^ (Si[(num3 >> 16) & 0xFF] << 16) ^ (Si[(num2 >> 24) & 0xFF] << 24)) ^ array[3];
        }
    }
}
