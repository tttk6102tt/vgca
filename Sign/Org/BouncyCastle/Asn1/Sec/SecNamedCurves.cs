    ...
    public sealed class SecNamedCurves
    {
        internal class Secp112r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("0409487239995A5EE76B55F9C2F098A89CE5AF8724C0A23E0E0FF77500"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp112r2Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("044BA30AB5E892B4E1649DD0928643ADCD46F5882E3747DEF36E956E97"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp128r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04161FF7528B899B2D0C28607CA52C5B86CF5AC8395BAFEB13C02DA292DDED7A83"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp128r2Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("047B6AA5D85E572983E6FB32A7CDEBC14027B6916A894D3AEE7106FE805FC34B44"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp160k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, zero, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("043B4C382CE37AA192A4019E763036F4F5DD4D7EBB938CF935318FDCED6BC28286531733C3F03C4FEE"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp160r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("044A96B5688EF573284664698968C38BB913CBFC8223A628553168947D59DCC912042351377AC5FB32"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp160r2Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("0452DCB034293A117E1F4FF11B30F7199D3144CE6DFEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp192k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, zero, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp192r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF101207192B95FFC8DA78631011ED6B24CDD573F977A11E794811"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp224k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, zero, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp224r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp256k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, zero, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp256r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("046B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp384r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode("04AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB73617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F"));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Secp521r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(1L);
                FpCurve fpCurve = new FpCurve(q, a, b);
                ECPoint g = fpCurve.DecodePoint(Hex.Decode(""));
                return new X9ECParameters(fpCurve, g, n, h, seed);
            }
        }
        ...
        internal class Sect131r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(131, 2, 3, 8, a, b, n, h);
        ...
        internal class Sect163k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(163, 3, 6, 7, a, b, n, h);
        ...
        internal class Sect193r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(193, 15, a, b, n, h);
        ...
        internal class Sect233k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                F2mCurve f2mCurve = new F2mCurve(233, 74, zero, b, n, h);
        ...
        internal class Sect233r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(233, 74, a, b, n, h);
        ...
        internal class Sect239k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                F2mCurve f2mCurve = new F2mCurve(239, 158, zero, b, n, h);
        ...
        internal class Sect283k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                F2mCurve f2mCurve = new F2mCurve(283, 5, 7, 12, zero, b, n, h);
        ...
        internal class Sect283r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(283, 5, 7, 12, a, b, n, h);
        ...
        internal class Sect409k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                F2mCurve f2mCurve = new F2mCurve(409, 87, zero, b, n, h);
        ...
        internal class Sect409r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(409, 87, a, b, n, h);
        ...
        internal class Sect571k1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(4L);
                F2mCurve f2mCurve = new F2mCurve(571, 2, 5, 10, zero, b, n, h);
        ...
        internal class Sect571r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                BigInteger h = BigInteger.ValueOf(2L);
                F2mCurve f2mCurve = new F2mCurve(571, 2, 5, 10, a, b, n, h);
